<?php
// ========== edit_gifted_responsible_user.php ==========
session_start();
...
// получаем организацию пользователя (не редактируется)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['save'])) {
        ...
        // организация всегда берётся из сессии
    ...
    $id                       // i
        ...
        $stmt->execute();
        header("Location: gifted_responsibles_user.php");
        exit;
    }
}
...
$stmt = $conn->prepare("
    SELECT teacher_name, position, education_level, qualification_category,
           experience_years, qualification_data, awards
...
<body>
  <div class="form-container">
    ...
    <div class="back-link">
      <a href="gifted_responsibles_user.php">← К списку ответственных</a>
    </div>
  </div>
</body>
</html>
