...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Выполняем вставку без указания responsible_id — AUTO_INCREMENT сработает автоматически
...
<head>
  ...
  <style>
    /* Стили из add_event.php, кнопки одного цвета */
  ...
  <div class="form-container">
    ...
    <form method="post">
      ...
      <div class="button-group">
        <a href="gifted_responsibles.php" class="btn-cancel">Отмена</a>
