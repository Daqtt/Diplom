...
// 1) Получаем список организаций из gifted_responsibles
...
");
if ($resOrg) {
    // в цикле сразу забираем каждую строку
    while ($row = $resOrg->fetch_assoc()) {
  ...
  <div class="form-container">
    ...
    <form method="POST">
      ...
      <div class="button-group">
        ...
        <a href="contests.php" class="btn-cancel">Отмена</a>
      </div>
    </form>
  </div>
</body>
